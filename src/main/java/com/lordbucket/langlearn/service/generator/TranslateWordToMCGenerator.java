...
@Component
public class TranslateWordToMCGenerator implements ITaskGenerator {
    private final SenseRepository senseRepository;
    private final Random random = new Random();

    public TranslateWordToMCGenerator(SenseRepository senseRepository) {
        this.senseRepository = senseRepository;
    }

    @Override
    public TaskType getTaskType() {
        return TaskType.TRANSLATE_WORD_TO_MC;
    }

    @Override
    public Class<?> getResponsePojoClass() {
        return TranslateWordToMCTask.class;
    }
    ...
    public Object generateTaskPojo(Topic topic) throws Exception {
        ...
        // Build the POJO
        return new TranslateWordToMCTask(
